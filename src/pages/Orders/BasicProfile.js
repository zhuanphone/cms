...
@connect(({ orders, loading }) => ({
  orders,
  loading: loading.effects.orders,
}))
      ...
      <PageHeaderWrapper title="订单详情页" loading={loading}>
        <Card bordered={false}>
          <DescriptionList size="large" title="订单详情" style={{ marginBottom: 32 }}>
            <Description term="订单Id">{order._id}</Description>
            <Description term="状态">{order.status}</Description>
            <Description term="订单总价">{order.amount}</Description>
